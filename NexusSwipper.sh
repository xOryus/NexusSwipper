...
# Constante utilizada para guardar a versão do programa.
VERSION='1.0'

# Tecla para cancelar o programa com [Ctrl]+[c]
trap __Ctrl_c__ INT
...
__Banner__() {
    ...
    echo -e "${YELLOW}################################################################################${END}"
    echo -e "${YELLOW}#                                                                              #${END}"
    echo -e "${YELLOW}#                             NEXUS SWIPPER                                    #${END}"
    echo -e "${YELLOW}#                            by: byelordy                                      #${END}"
...
__FindLinks__() {
    # Quebrando as linhas para melhorar a seleção dos links, onde
